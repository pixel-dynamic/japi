        ...
        <b-col>
          ...
          <b-card class="px-2 px-md-5 py-4 small">
            <p>
              ...
              personales, laborales, financieros y patrimoniales, así como las
              ...
              Información personal La información personal solicitada al usuario
              está compuesta por los siguientes rubros: nombre(s), apellido(s),
              fecha de nacimiento, sexo, correo electrónico, teléfono fijo,
              teléfono celular, domicilio, estado, delegación o municipio,
              calle, número exterior e interior, país, ingreso mensual,
              información patrimonial, referencias personales, datos médicos y
              valor del inmueble sujeto a garantía hipotecaria. Tus datos
              personales serán tratados con base en los principios de licitud,
              consentimiento, información, calidad, finalidad, lealtad,
              proporcionalidad y responsabilidad de la Ley Federal de Protección
            ...
            <p>
              ...
              evitar su daño, pérdida, alteración, destrucción, uso, acceso o
              divulgación indebida. La información deberá ser veraz y completa.
              El usuario responderá en todo momento por los datos proporcionados
              y en ningún caso mini.mx será responsable de la veracidad de los
              mismos. Uso de los datos personales En caso de que aceptes los
              términos de este Aviso de Privacidad, tus datos personales serán
              usados para:
            </p>
            <ul>
              <li>
                ...
                crediticia, con la finalidad de aplicar a sus propios procesos
                de solicitud de cotización de productos financieros, de seguros
                y de inmuebles, para poder ofrecerte el producto que se
                considere adecuado a tus necesidades.
              </li>
              <li>
                ...
                desarrolladores inmobiliarios y entidades de investigación
                crediticia. De igual manera estos datos serán utilizados para:
              </li>
              <ul>
            ...
            <p>
              Entiéndase por terceros a cualquier banco y/o entidad financiera
              y/o aseguradora y/o cualquier compañía que preste cualquier tipo
            ...
            <p>
              Qué son las cookies y cómo se utilizan Las cookies son pequeñas
              piezas de información que son enviadas por el sitio web a tu
              navegador y se almacenan en el disco duro de tu equipo. Se
              utilizan para determinar tus preferencias cuando te conectas a los
              servicios de nuestros sitios, así como para rastrear determinados
              comportamientos o actividades llevadas a cabo por ti dentro del
              portal. Existen secciones de la página web en las que requerimos
              que el usuario tenga habilitadas las cookies, ya que algunas de
              las funcionalidades del sitio web las necesitan para trabajar. Las
              cookies nos permiten:
            </p>
            <ul>
              <li>
                a) Reconocerte al momento de entrar a nuestros sitios y
                ofrecerte una experiencia personalizada.
              </li>
              <li>
                b) Conocer la configuración personal del sitio especificada por
                ti; por ejemplo, las cookies nos permiten detectar el ancho de
                banda que has seleccionado al momento de ingresar a la página de
                inicio de nuestros sitios, así sabemos qué tipo de información
                es aconsejable descargar.
              </li>
              <li>
                c) Calcular el tamaño de nuestra audiencia y medir algunos
                ...
                útil para mejorar el contenido, los titulares y las promociones
                para los usuarios.
              </li>
            </ul>
            <p>
            ...
            <p>
              En el caso de que sea necesaria la utilización de cookies, el
              botón de “ayuda” que se encuentra en la barra de herramientas de
              la mayoría de los navegadores te dirá cómo aceptar nuevas cookies,
              cómo hacer que el navegador te notifique cuando recibes una nueva
            ...
            <p>
              ...
              sociales, fax, a través del portal o por teléfono.
            </p>
            <p>
            ...
            <p>
              ...
              tanto, darlos de baja para que no se usen; (d) cualquier otro
            ...
            <ul>
              ...
              <li>
                ...
                nuestro sitio web y otorguen un servicio/producto solicitado por
                el usuario. Estos terceros tienen un control parcial de estos
                datos. Es importante que leas sus avisos de privacidad o los
                contactes directamente para información adicional.
              </li>
              <li>
            ...
            <p>
              ...
              cumplimiento de estas últimas de los ofrecimientos presentados en
              sus cotizaciones. Los resultados que su comparador arroja son para
            ...
            <p>
              ...
              políticas internas, nuevos requerimientos para la prestación u
